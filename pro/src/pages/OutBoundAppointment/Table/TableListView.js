...
import { deleteItem } from '@/services/OutboundAppointment/index';
...
@connect(({ outboundAppointment, loading }) => {
  return {
    list: outboundAppointment.list,
    pagination: outboundAppointment.pagination,
     density:global.density || 8,
    loading: loading.effects['outboundAppointment/fetch'] || false,
  };
})
class TableListView extends React.Component {
  ...
  get columns() {
    const result = [
    {
      ...
      dataIndex: 'snumber',
      key: 'snumber',
      sorter: (a, b) => { return a.snumber - b.snumber;},
      width: 180,
    ...
    }, 
    {
      ...
      align:'center',
      title: '送货方式',
      dataIndex: 'conveywayname',
      key: 'conveywayname',
      sorter: (a, b) => { return a.conveywayname - b.conveywayname;},
      width: 120,
    ...
    }, 
    {
      ...
      align:'center',
      title: '配送点',
      dataIndex: 'deliverydotname',
      key: 'deliverydotname',
      sorter: (a, b) => { return a.deliverydotname - b.deliverydotname;},
      width: 200,
  ...
  getList(query) {
    ...
    dispatch({
      type: 'outboundAppointment/fetch',
      payload: query,
    });
  }
  ...
  <AuthorizedButton
          ...
          onClick={() => {
            this.props.history.push(`/stockout/outboundAppointment/${record.id}`);
          }}
        />
        <AuthorizedDetailButton
          ...
          permissionKey={record.billstatus}
          onClick={() => {
            this.props.history.push(`/stockout/outboundAppointment/detail/${record.id}`);
          }}
        />
        <AuthorizedDelete
          title='删除'
      ...
      <div className={styles.tableView} ref={(el) => { this.parent = el; }}>
        <div className={styles.btnGroup} ref={(el) => { this.btnGroup = el; }}>
          <Button
            ...
            onClick={() => {
              this.props.history.push('/stockout/outboundAppointment/add')
            }}
          >
            新增
          </Button>
