...
import DeliveryField from '@/components/widgets/DeliveryField'

import { formMap } from './OOMap'
import { OOMTransfer } from '@/utils/OOM'
import { FormResponsive } from '@/config/style'

import { detailService } from '@/services/OutboundAppointmentEdit'
        ...
        <Row>
          ...
          <Col {...formResponsive[Field.planoperationtime]}>
            <Form.Item
              ...
              className={styles.formItem}
              rules={[{ required: true, message: '请选择出库预约时间' }]}
              label="出库预约时间"
            >
              <TimeField />
            </Form.Item>
