...
class EditableTable extends React.Component {
  ...
  modifyRow = (row = {}) => {
    ...
    debugger
    dispatch({
      type: 'outboundAppointmentEdit/modifyRow',
      payload: {
        row,
      }
    })
...
export default connect(({ outboundAppointmentEdit }) => {
  console.log(outboundAppointmentEdit.editList,'editList')
  return { editList: outboundAppointmentEdit.editList }
})(EditableTable);