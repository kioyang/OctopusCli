...
@connect(({ batchStockEdit, loading,global }) => {
  return {
    list: batchStockEdit.list,
    buttonLoading: loading.effects['batchStockEdit/saveObject'] || false,
    editList: batchStockEdit.editList,
    density: global.density || GlobalDensity.normal,
    pagination: batchStockEdit.pagination,
    loading: loading.effects['batchStockEdit/fetch'] || false,
  };
})
