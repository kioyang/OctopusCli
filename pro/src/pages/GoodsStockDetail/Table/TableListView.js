...
@connect(({ goodsStockDetail, loading, global }) => {
  return {
    list: goodsStockDetail.detailList,
    density: global.density,
    pagination: goodsStockDetail.pagination,
    loading: loading.effects['goodsStockDetail/fetch'] || false,
  };
})
