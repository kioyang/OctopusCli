...
// indexpage
export default connect(({ outboundEdit , loading }) => {
  return {
    editList: outboundEdit.editList, // 为了提交获取editList
    loading: loading.effects['outboundEdit/saveObject'] || false,
  }
})(Index);
