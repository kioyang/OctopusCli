...
@connect(({ outboundEdit, loading,global }) => {
  return {
    list: outboundEdit.list,
    buttonLoading: loading.effects['outboundEdit/saveObject'] || false,
    editList: outboundEdit.editList,
    density: global.density || GlobalDensity.normal,
    pagination: outboundEdit.pagination,
    loading: loading.effects['outboundEdit/fetch'] || false,
  };
})
