...
@connect(({ goodsStockEdit, loading,global }) => {
  return {
    list: goodsStockEdit.list,
    buttonLoading: loading.effects['goodsStockEdit/saveObject'] || false,
    editList: goodsStockEdit.editList,
    density: global.density || GlobalDensity.normal,
    pagination: goodsStockEdit.pagination,
    loading: loading.effects['goodsStockEdit/fetch'] || false,
  };
})
      ...
      <div className={styles.tableView} ref={(el) => {
        ...
        <div className={styles.fixedTopLeft}>
          <Button
            ...
            onClick={() => {
              this.props.history.push('/&#x2F;portal&#x2F;rs&#x2F;stock&#x2F;page/goodsStock')
            }}
          >返回</Button>
          <br />
        </div>
