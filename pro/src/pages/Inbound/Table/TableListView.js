...
import { deleteItem } from '@/services/Inbound/index';
...
@connect(({ inbound, loading }) => {
  return {
    list: inbound.list,
    pagination: inbound.pagination,
     density:global.density || 8,
    loading: loading.effects['inbound/fetch'] || false,
  };
})
class TableListView extends React.Component {
  ...
  get columns() {
    ...
    }, 
    {
      ...
      dataIndex: 'qacontrol',
      key: 'qacontrol',
      sorter: (a, b) => { return a.qacontrol - b.qacontrol;},
      width: 120,
    ...
    }, 
    {
      ...
      key: 'operationtime',
      sorter: (a, b) => { return a.operationtime - b.operationtime;},
      width: 180,
    ...
    }, 
    {
      ...
      key: 'contractno',
      sorter: (a, b) => { return a.contractno - b.contractno;},
      width: 120,
    ...
    }, 
    {
      ...
      dataIndex: 'remark',
      key: 'remark',
      sorter: (a, b) => { return a.remark - b.remark;},
      width: 200,
  ...
  <AuthorizedButton
          ...
          onClick={() => {
            this.props.history.push(`/stockin/inbound/${record.id}`);
          }}
        />
        <AuthorizedDetailButton
          ...
          permissionKey={record.billstatus}
          onClick={() => {
            this.props.history.push(`/stockin/inbound/detail/${record.id}`);
          }}
        />
        <AuthorizedDelete
          title='删除'
      ...
      <div className={styles.tableView} ref={(el) => { this.parent = el; }}>
        <div className={styles.btnGroup} ref={(el) => { this.btnGroup = el; }}>
          <Button
            ...
            onClick={() => {
              this.props.history.push('/stockin/inbound/add')
            }}
          >
            新增
          </Button>
