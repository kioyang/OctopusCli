...
import { deleteItem } from '@/services/BatchStock/index';
...
@connect(({ batchStock, loading }) => {
  return {
    list: batchStock.list,
    pagination: batchStock.pagination,
     density:global.density || 8,
    loading: loading.effects['batchStock/fetch'] || false,
  };
})
class TableListView extends React.Component {
  ...
  get columns() {
    ...
    }, 
    {
      ...
      align:'center',
      title: '储存方式',
      dataIndex: 'storageMethodName',
      key: 'storageMethodName',
      sorter: (a, b) => { return a.storageMethodName - b.storageMethodName;},
      width: 120,
  ...
  <AuthorizedButton
          ...
          onClick={() => {
            this.props.history.push(`/&#x2F;portal&#x2F;rs&#x2F;stock&#x2F;queryStockInfo/batchStock/${record.id}`);
          }}
        />
        <AuthorizedDetailButton
          ...
          permissionKey={record.billstatus}
          onClick={() => {
            this.props.history.push(`/&#x2F;portal&#x2F;rs&#x2F;stock&#x2F;queryStockInfo/batchStock/detail/${record.id}`);
          }}
        />
        <AuthorizedDelete
          title='删除'
      ...
      <div className={styles.tableView} ref={(el) => { this.parent = el; }}>
        <div className={styles.btnGroup} ref={(el) => { this.btnGroup = el; }}>
          <Button
            ...
            onClick={() => {
              this.props.history.push('/&#x2F;portal&#x2F;rs&#x2F;stock&#x2F;queryStockInfo/batchStock/add')
            }}
          >
            新增
          </Button>
